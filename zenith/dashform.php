...
<caption><h1 style="color:black"> CONFORM PAYMENT</h1> </caption>
<tr>
	<td> <input  style="height:35px;width:320px" type="text" id="idName" name="uName" placeholder="coursename" required>
</tr>
<tr>
