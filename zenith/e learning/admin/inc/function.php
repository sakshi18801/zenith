...
function view_lang(){
    ...
    while($row=$get_lang->fetch()):
        echo"<tr>
                ...
                <td>".$row['lang_name']."</td>
                <td>
                    <a href='index.php?lang&edit_lang=".$row['lang_id']."' title='Edit'>Edit</a>
                    <a style='color:#f00' href='index.php?lang&del_lang=".$row['lang_id']."' title='Delete'>Delete</i></a>
                </td>
    ...
    if(isset($_GET['del_lang'])) {
        ...
        function view_cat(){
            ...
            while($row=$get_cat->fetch()):
                echo"<tr>
                        ...
                        <td>
                            <a href='index.php?cat&edit_cat=".$row['cat_id']."' title='Edit'>Edit</a>
                            <a style='color:#f00' href='index.php?cat&del_cat=".$row['cat_id']."' title='Delete'>Delete</i></a>
                        </td>
        ...
        function add_sub_cat(){
            ...
            if(isset($_POST['add_sub_cat'])){
                ...
                $check=$con->prepare("select * from cat where sub_cat_name='$cat_name'");
                $check->setFetchMode(PDO:: FETCH_ASSOC);
                $check->execute();
                $count=$check->rowCount();
        ...
        function view_sub_cat(){
            ...
            while($row=$get_cat->fetch()):
                ...
                echo"<tr>
                        ...
                        <td>
                        <a href='index.php?sub_cat&edit_sub_cat=".$row['sub_cat_id']."' title='Edit'>Edit</a>
                        <a style='color:#f00' href='index.php?sub_cat&del_sub_cat=".$row['sub_cat_id']."' title='Delete'>Delete</i></a>
                    </td>
        ...
        function view_term(){
            include("inc/db.php");
                ...
                echo"<tr>
                        ...
                        <td>".$row['for_whom']."</td>
                        <td>
                        <a href='index.php?terms&edit_term=".$row['t_id']."' title='Edit'>Edit</a>
                        <a style='color:#f00' href='index.php?terms&del_term=".$row['t_id']."' title='Delete'>Delete</i></a>
                    </td>
            ...
            while($row=$get_faqs->fetch()):
                echo " <details>
                            ...
                            <form method='post' enctype='multipart/form-data'>
                                <input type='text' name='up_qsn' value='".$row['qsn']."' placeholder='Enter QSN Here' />
